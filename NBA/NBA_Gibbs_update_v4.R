...
for(i in 1:1230){
				...
				x3[i,(n.raw1[i,3])]<- -(period2[i])
				x4[i,(n.raw1[i,3])]<- -(period3[i])
				x5[i,(n.raw1[i,3])]<- -(period4[i])
...
w1<-bbet1 <- data.frame(c(levels(name1[,1])),best[32:61])
w2<-bbet2<- data.frame(c(levels(name1[,1])),best[62:91])
w3<-bbet3<- data.frame(c(levels(name1[,1])),best[92:121])
w4<-bbet4<- data.frame(c(levels(name1[,1])),best[122:151])
w5<-bbet5<- data.frame(c(levels(name1[,1])),best[152:181])
...
legend(0.2, 0.5, legend=name1[ix, 1], lty=1:sum(ix), col=1:sum(ix))
