...
m.week0<-data.matrix(week0)   #   look at this
m.week1<-data.matrix(week1)   #   look at this
...
diagsigma<- diag(c(1, 0.01*rep(1, 30), 0.01*rep(1, 30),1.01*rep(1,30)))
...
ww <- cbind(w1, w2)
matplot(c(1, 2), t(ww),type='l', xlab="week", ylab="ability")
ix <- w2 > 0.15
